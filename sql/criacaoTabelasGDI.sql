...
CREATE table telefone_pessoa(
    ...
    CONSTRAINT telefone_pessoa_fk FOREIGN KEY (cpf_p) REFERENCES pessoa (cpf)
);
...
CREATE table cliente_balconista_medicamento(
    ...
    CONSTRAINT cbm_id_medicamento_fk FOREIGN KEY (id_medicamento, cpf_p_medicamento, id_composto_medicamento) REFERENCES medicamento_manipulado(id, cpf_p, id_composto)
);
...
CREATE table desconto(
    ...
    promocao VARCHAR2(5),
    valor NUMBER,
    CONSTRAINT desconto_pk PRIMARY KEY (cpf_c, cpf_b, id_medicamento_cbm, cpf_p_medicamento_cbm, id_composto_medicamento_cbm, promocao),
    CONSTRAINT desconto_cbm_fk FOREIGN KEY (cpf_c, cpf_b, id_medicamento_cbm, cpf_p_medicamento_cbm, id_composto_medicamento_cbm) REFERENCES cliente_balconista_medicamento(cpf_c, cpf_b, id_medicamento, cpf_p_medicamento, id_composto_medicamento),
